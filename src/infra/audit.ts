...
export const AuditAction = {
  ...
  JIRA_CONNECTION_TEST: 'jira_connection_test',
  ...
  ADMIN_CONNECTION_CREATE: 'admin_connection_create',
  ADMIN_CONNECTION_UPDATE: 'admin_connection_update',
  ADMIN_CONNECTION_DELETE: 'admin_connection_delete',
